...
# if PAGES_REPO_NWO is not set then default to publiccodenet/process-code-software-procurement-new
...
export PAGES_REPO_NWO=publiccodenet/process-code-software-procurement-new
fi
